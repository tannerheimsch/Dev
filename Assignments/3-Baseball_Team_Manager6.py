...
def display_lineup(players):
    if not players:
        ...
        for i, player in enumerate(players, start=1):
            ...
            print(f"{i:<5}{name:<10}{position:<10}{at_bats:<10}{hits:<10}{avg:<10.3f}")
...
def main():
    players = []  # Initialize list of lists to store each player in the lineup
    ...
    while True:
        ...
        if menu_option != 7:
            display_menu()  # Display the menu after each prompt except when exiting
#endregion
